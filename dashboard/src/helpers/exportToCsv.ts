/*
    ...
    https://github.com/alexcaza/export-to-csv (Author: Alex Caza)
    https://github.com/javiertelioz/angular2-csv (Author: Javier Telio)
...
export class ExportToCsv {
     ...
     * Generate Blob
     */
    generateBlob(jsonData: any, shouldReturnCsv: boolean = false): void | any {
